...
> **1535 quality-gated papers · 15 research directions · primary paper links · official code links when verified**

<div align="center">

[**🆕 Latest 30 Days · 391 tracked**](LATEST_30D.md) · [**🏛️ Classical · 1401**](CLASSICAL.md) · [**📚 Paper Library**](ALL_PAPERS.md) · [**🧩 JSON**](../data/papers.json)
...
|---:|---|---:|---:|
| 01 | [**LLM Serving**](01-llm-serving.md) | **655** | **270** |
...
| 08 | [**GPU Kernel / DSL / Compiler**](08-gpu-kernel-compiler.md) | **386** | **87** |
...
| 15 | [**Edge / Cloud / Heterogeneous AI**](15-edge-cloud-heterogeneous.md) | **321** | **113** |
