...
> **736 quality-gated papers · 15 research directions · primary paper links · official code links when verified**

<div align="center">

[**🆕 Latest 30 Days · 194 tracked**](LATEST_30D.md) · [**🏛️ Classical · 690**](CLASSICAL.md) · [**📚 Paper Library**](ALL_PAPERS.md) · [**🧩 JSON**](../data/papers.json)
...
| 03 | [**KV Cache / Long Context**](03-kv-cache-long-context.md) | **193** | **34** |
...
| 08 | [**GPU Kernel / DSL / Compiler**](08-gpu-kernel-compiler.md) | **264** | **62** |
...
| 15 | [**Edge / Cloud / Heterogeneous AI**](15-edge-cloud-heterogeneous.md) | **172** | **68** |
